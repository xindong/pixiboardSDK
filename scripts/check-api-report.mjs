...
const reports = [
  ...
  ["@pixi-board/capabilities", join(root, "packages/capabilities/etc/pixi-board-capabilities.api.md")],
  ["@pixi-board/agent-tools", join(root, "packages/agent-tools/etc/pixi-board-agent-tools.api.md")],
  ["@pixi-board/agent-tools/schemas", join(root, "packages/agent-tools/etc/pixi-board-agent-tools-schemas.api.md")],
];
const extractorRuns = [
  ["@pixi-board/core", []],
  ["pixiboardjs", []],
...
for (const [name, report] of reports) {
  try {
    ...
    if (/node_modules|@pixi-board\/(adapter-browser|adapter-tauri|renderer-pixi|plugin-api-v3)/.test(text)) blockers.push(`${name}: report references a private workspace package`);
  } catch (error) {
