...
- 7febced: Make selection resizing proportional by default, with Command/Ctrl unlocking freeform resizing in the site transformer.
...
All notable changes to `pixiboardjs` will be documented here.

## Unreleased

- Added the P6 publishability workflow and artifact checks.
