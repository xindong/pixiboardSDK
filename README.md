...
[![CI gates](https://github.com/maoxinxin-xd/pixiboardSDK/actions/workflows/ci.yml/badge.svg)](https://github.com/maoxinxin-xd/pixiboardSDK/actions/workflows/ci.yml)
[![Deploy GitHub Pages](https://github.com/maoxinxin-xd/pixiboardSDK/actions/workflows/deploy-pages.yml/badge.svg)](https://github.com/maoxinxin-xd/pixiboardSDK/actions/workflows/deploy-pages.yml)
...
**[🎮 在线可交互 Demo](https://maoxinxin-xd.github.io/pixiboardSDK/)** · [文档](docs/README.md) · [架构决策记录](docs/adr)
...
**[👉 点这里看在线可交互 Demo](https://maoxinxin-xd.github.io/pixiboardSDK/)** —— 这是真实运行的 `pixiboardjs` 包，不是截图；可以拖拽节点、缩放平移、撤销重做、切换自定义节点状态。
...
CI 在 [`.github/workflows/ci.yml`](.github/workflows/ci.yml) 中对每次 push/PR 运行静态边界检查、核心契约测试、Chromium 浏览器契约与性能回归门；桌面 Tauri 集成的 macOS/Windows 门见 [`desktop-launch-smoke.yml`](.github/workflows/desktop-launch-smoke.yml)。
...
[MIT](LICENSE) © 2026 [maoxinxin-xd](https://github.com/maoxinxin-xd)
